            ...
            <Card>
              <CardBody>
                <div className={classes.cardHeader}>
                  <h4 className={classes.cardTitle}>Estilos de Notificações</h4>
                </div>
                <br />
                <SnackbarContent
          ...
          <GridItem xs={12} sm={12} md={6}>
            <Card>
              <CardBody>
                <div>
                  <div className={classes.cardHeader}>
                    <h4 className={classes.cardTitle}>Estados de notificação</h4>
                  </div>
                  <br />
                  <SnackbarContent
                    message={
                    ...
                    <GridItem xs={12}>
                      ...
                      >
                        ...
                        <p className={classes.cardSubtitle}>
                          Clique para ver as notificações
                        </p>
                      </div>
                    </GridItem>
                  </GridContainer>
